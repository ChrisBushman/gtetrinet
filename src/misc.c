...
/* The 9 "black" slots below are remapped to white (0xFF/0xFF/0xFF)
 * instead of literal black. Real servers (e.g. jetrix's StatsFilter,
 * which wraps line/tetris/special counts in <black>...</black>) send
 * these codes assuming a light chat background, where black is a
 * highlight color -- but this client's window is permanently dark
 * (see gtetrinet.c's SDL_MapRGB(10,10,10) clear color), so literal
 * black text is always invisible here regardless of server intent. */
static const SDL_Color gtet_colors[COLORNUM] = {
    {0xFF, 0xFF, 0xFF, 0xFF}, /* ^A black -> white (see note above) */
    {0xFF, 0xFF, 0xFF, 0xFF}, /* ^B black -> white */
    {0x00, 0xFF, 0xFF, 0xFF}, /* ^C cyan */
    {0xFF, 0xFF, 0xFF, 0xFF}, /* ^D black -> white */
    {0x00, 0x00, 0xFF, 0xFF}, /* ^E bright blue */
    {0x7F, 0x7F, 0x7F, 0xFF}, /* ^F grey */
    {0xFF, 0xFF, 0xFF, 0xFF}, /* ^G black -> white */
    {0xFF, 0x00, 0xFF, 0xFF}, /* ^H magenta */
    {0xFF, 0xFF, 0xFF, 0xFF}, /* ^I black -> white */
    {0xFF, 0xFF, 0xFF, 0xFF}, /* ^J black -> white */
    {0x7F, 0x7F, 0x7F, 0xFF}, /* ^K grey */
    {0x00, 0x7F, 0x00, 0xFF}, /* ^L dark green */
    {0xFF, 0xFF, 0xFF, 0xFF}, /* ^M black -> white */
